...
Version: `r packageVersion('pltesim')` [![CRAN Version](http://www.r-pkg.org/badges/version/pltesim)](https://CRAN.R-project.org/package=pltesim)
...
![CRAN Monthly Downloads](http://cranlogs.r-pkg.org/badges/last-month/pltesim)
![CRAN Total Downloads](http://cranlogs.r-pkg.org/badges/grand-total/pltesim)
...
```{r onetime, fig.path='man/figures/'}
# One-time
...
```{r temp-multievent, fig.path='man/figures/'}
# Temporary
...
```{r custom-baseline, fig.path='man/figures/'}
